# Generated on 2014-09-06 using generator-ionic 0.5.3
"use strict"
_ = require("lodash")
path = require("path")
...
module.exports = (grunt) ->
  ...
  _.functions(cordova).forEach (name) ->
    ...
    grunt.registerTask name, ->
      ...
      exec = (if process.platform is "win32" then "cordova.cmd" else "cordova")
      cmd = path.resolve("./node_modules/cordova/bin", exec)
